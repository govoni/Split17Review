...
In Refs.~\cite{Biedermann:2017bss}, for the first time, all leading order (LO) and NLO contributions to the full ${\rm p}{\rm p}\to\mu^+\nu_\mu{\rm e}^+\nu_{\rm e}{\rm j}{\rm j}$ process have been reported. \footnote{The $\mathcal{O}{\left(\alpha^{7}\right)}$ corrections
...
The program {\sc Bonsay} consists of a general-purpose Monte Carlo integrator

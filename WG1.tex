...
{\sc Powheg}~\cite{},
{\sc Recola+Collier}~\cite{Actis:2012qn,Actis:2016mpe,Denner:2014gla,Denner:2016kdg},
...
NLO QCD corrections at fixed-order ($\mathcal O (\alpha^6\alpha_s)$, for the process $p p \to e^+ \nu_e \mu^+ \nu_\mu j j$. In 

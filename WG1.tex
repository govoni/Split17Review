In the past years, the study of the VBS processes has attracted lots of interests in the theory community, (see \emph{e.g.}\ Ref.~\cite{Rauch:2016pai} for 
a recent review).
...
We conclude by stressing one point, the fact that usually EW corrections are particularly large only in phase space regions which are suppressed.
...
approximation and including the s-channel tri-boson contribution,
...
New physics model could lead to large contributions to the longitudinal polarisation of heavy gauge bosons.
...
In this respect, a new method has been proposed and applied to the scattering of two W bosons of opposite charge \cite{Ballestrero:2017bxn}.
